...
- data.csv # transcriptome counts  
- dbcan_coverage80.csv  # dbcan annotation
- MetaG_KEGG_dbcan.xlsx # KEGG annotation


Note that in this script, "DNAsense_id" is called "sample", "GeneID" = "locus_tag" and "ManuscriptID" = "experimental factor".
...
dat <- read_delim("data_used/data.csv",delim = ";") %>%
...
dbcan:
```{r }
#load the dbCan file from Hanna's folder "dbcan_coverage80.csv"
